    ...
    public partial class HistoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [History] WHERE (([Id] = @Original_Id) AND ([URL] = @Original_URL) AN" +
                "D ([Title] = @Original_Title) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Da" +
                "te] = @Original_Date)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [History] SET [URL] = @URL, [Title] = @Title, [Date] = @Date WHERE (([Id] = @Original_Id) AND ([URL] = @Original_URL) AND ([Title] = @Original_Title) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)));
SELECT Id, URL, Title, Date FROM History WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WebBrowser.Data.Properties.Settings.Default.BrowserDBConnectionString;
        }
